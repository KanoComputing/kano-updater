# -*- coding: utf-8 -*-
#
# kano-updater documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'kano-updater.tex', u'kano-updater Documentation',
...
man_pages = [
    (master_doc, 'kano-updater', u'kano-updater Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kano-updater', u'kano-updater Documentation',
     author, 'kano-updater', 'One line description of project.',
     'Miscellaneous'),
]
